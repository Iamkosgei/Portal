...
class _$SubmissionImpl implements _Submission {
  ...
  @override
  String toString() {
    return 'Submission(id: $id, questionId: $questionId, question: $question, submittedAnswer: $submittedAnswer, totalMarks: $totalMarks, correctAnswer: $correctAnswer)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, questionId, question,
      submittedAnswer, totalMarks, correctAnswer);
...
abstract class _Submission implements Submission {
  const factory _Submission(
      ...
      required final String correctAnswer}) = _$SubmissionImpl;
