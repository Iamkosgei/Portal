...
// in portal/test/features/submissions/data/repositories/submission_repository_impl_test.dart.
...
/// A class which mocks [SubmissionDao].
///
/// See the documentation for Mockito's code generation for more information.
class MockSubmissionDao extends _i1.Mock implements _i4.SubmissionDao {
  MockSubmissionDao() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> insertSubmission(_i8.SubmissionEntity? submission) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertSubmission,
          [submission],
  ...
  @override
  _i5.Future<List<_i8.SubmissionEntity>> getSubmissionsForQuestion(
          String? questionId) =>
      (super.noSuchMethod(
        Invocation.method(
        ...
        returnValue: _i5.Future<List<_i8.SubmissionEntity>>.value(
            <_i8.SubmissionEntity>[]),
      ) as _i5.Future<List<_i8.SubmissionEntity>>);

  @override
  _i5.Future<List<_i8.SubmissionEntity>> getAllSubmissions() =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllSubmissions,
          [],
  ...
  @override
  _i5.Future<_i8.SubmissionEntity?> getSubmissionById(String? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getSubmissionById,
          [id],
        ),
        returnValue: _i5.Future<_i8.SubmissionEntity?>.value(),
      ) as _i5.Future<_i8.SubmissionEntity?>);

  @override
  _i5.Future<void> deleteSubmissionsForQuestion(String? questionId) =>
      (super.noSuchMethod(
        Invocation.method(
          #deleteSubmissionsForQuestion,
          [questionId],
        ),
        returnValue: _i5.Future<void>.value(),
        returnValueForMissingStub: _i5.Future<void>.value(),
  ...
  @override
  _i5.Future<void> deleteSubmission(String? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteSubmission,
          [id],
        ),
